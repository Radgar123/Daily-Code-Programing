...
public class TestBubbleSortElementy
{
    public static void main(String[] args) throws FileNotFoundException
    {
        PrintWriter save = new PrintWriter("BubbleSortZlozony.txt");
       ...
       /* Student[] tabStudent =
        ...
        BubbleSort sor = new BubbleSort(zlozony);
        ...
        for (int i=0;i<tabStudent1.length;i++)
        {
            //System.out.println(tabStudent1[i]);
